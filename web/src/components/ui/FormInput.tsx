...
const FormInput = forwardRef<HTMLInputElement, FormInputProps>(
  ({ label, error, helpText, id, className = '', type, ...props }, ref) => {
      ...
      <div>
        ...
        <div className="relative mt-1">
          <input
            ...
            className={`block w-full rounded-lg border px-3 py-2 shadow-sm transition-colors focus:outline-none focus:ring-1 ${
              error
